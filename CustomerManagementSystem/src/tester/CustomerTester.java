...
public class CustomerTester {
	...
	public static void main(String[] args) {
		...
		List<Customer> custlist=populateData();
			...
			while(!done)
			{
				...
				try {
					...
					case 5:
						...
						break;
					case 6:
						//custlist.sort((c1,c2)->c1.getDob().compareTo(c2.getDob()));
						custlist.stream().sorted((c1,c2)->c1.getDob().compareTo(c2.getDob())).forEach(cust->System.out.println(cust));
					//Collections.sort(custlist,(c1,c2)->c1.getDob().compareTo(c2.getDob()));
						break;
					case 0: done = true;
					break;
